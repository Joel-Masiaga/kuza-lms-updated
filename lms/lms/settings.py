...
INSTALLED_APPS = [
    ...
    'django.contrib.messages',
    'django.contrib.staticfiles',
    'cloudinary_storage',  # Must be before 'django.contrib.staticfiles' if using for static
    'cloudinary',
    'home',
    'chatboat',
    'courses',
...
# This is now active and provides credentials for the storage backend.
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': os.getenv('CLOUDINARY_CLOUD_NAME'),
    'API_KEY': os.getenv('CLOUDINARY_API_KEY'),
    'API_SECRET': os.getenv('CLOUDINARY_API_SECRET')
...
if ENVIRONMENT == 'development':
    ...
    # In production, MEDIA_URL and MEDIA_ROOT are handled by Cloudinary
    # and do not need to be set to a local path.
